...
#define GAME_CYCLE_TIME		 100		// 每33ms跑一次Move及Show(每秒30次)
...
public:
	...
	void  SetCurrentBitmap(int);	// 動畫直接跳到第X張bitmap
...
class CGameStateNekoWin;
class CGameStateRivalWin;
class CGameStateStageSelect;
